...
class Slide{
    constructor(){
        ...
        this.banners = [
            {
                imageName: 'https://img.onl/6hYNIX',  
            },
            {
                imageName: 'https://img.onl/KXmY8K',  
            },
            {
                imageName: 'https://img.onl/UFgob8',  
            },
            {
                imageName: 'https://img.onl/6azMe0',  
            },
            {
                imageName: 'https://img.onl/Ymdzq5',  
            },
        ];
        this.imageUrl = '';
